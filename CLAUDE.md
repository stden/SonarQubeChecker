...
### Принципы разработки проекта SonarQubeChecker

- **DRY (Don't Repeat Yourself)**: избегаем дублирования кода, знаний и логики; каждое знание фиксируем в одном источнике.
- **Гибкость и модульность**: проектируем компоненты так, чтобы их можно было развивать и заменять; используем слабую связанность и чёткие интерфейсы.
- **Контрактное программирование**: описываем ожидания и ответственность модулей через пред- и постусловия, тесты и ревью.
